...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Invoices and Quotations</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="profile.php?user="+user>Profile</a></li>
                        <li class="breadcrumb-item"><a href="profile-invoices.php">Invoices</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Document ID: <span  id="title"></span></h4>
                                <h6 class="card-subtitle" id="user-issue">Complete and Download</h6>
                                <hr>
                                File: <span id="file"></span> || Issued Date: <span id="issued"></span>
                                <br>
                                <br>
                                <button class="btn btn-info" id="btn-pay">Pay</button>
                                |
                                <button class="btn btn-success" id="btn_gen">Download Quotation</button>
    ...
    <script>
        ...
        // Data
        refList.doc(param).get().then((doc) => {
            user_is.innerText = doc.data().issuedBy;
            issued.innerText = user.innerText = doc.data().date.toDate();
            file.innerText = doc.data().name;

            if(doc.data().accepted&&doc.data().accepted==true){
                document.getElementById('btn_gen').innerText = "Download Invoice";
                btn_pay.style.display = "none";
            }
        });

        btn_pay.addEventListener('click', () => {
            window.location.href = "payment-invoice.php?id="+param; 
        })
        ...
        document.getElementById('btn_gen').addEventListener('click', () => {
            ...
            refList.doc(param).get().then((doc) => {
                doc.data().books.forEach((book) => {
                    total = parseInt(book.price)*book.qty + total;
                });
                if(doc.data().accepted&&doc.data().accepted==true){
                    ...
                    fileName: `Invoice Date: ${new Date().getDate()}/${new Date().getMonth()+1}/${new Date().getFullYear()}`,
                    ...
                    invoice: {
                        label: `Invoice from: ${doc.data().issuedBy||"Not Mentioned"}`,
                        num: 19,
                        invGenDate: `Invoice Date: ${new Date().getDate()}/${new Date().getMonth()+1}/${new Date().getFullYear()}`,
                        headerBorder: false,
                        ...
                        table: Array.from(doc.data().books, (item, index)=>([
                            index + 1,
                            item.book,
                            item.qty,
                            item.price,
                        ...
                        invDescLabel: `Invoice Total  = Rs. ${total}`,
                    ...
                    invoice: {
                        label: `Quotation from: ${doc.data().issuedBy||"Not Mentioned"}`,
                        num: 19,
