        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Chatbot</h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" id="title">Chat Section</h4>
                                <h6 class="card-subtitle">Use this for communication.</h6>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            <div class="col">
                            <p>Type what you want to communicate with your partner. Use following panel.</p>
                            <!-- Divider -->
                            <hr>
                            ...
                            <div class="col">
                                ...
                                <table  id="chat-table">
                                    <tr>
                                    <td><div class="left-bubble">Hello! Welcome to AutoPart Division.</div></td>
                                    <td></td>
                                    </tr>
                                    <tr>
                                    <td></td>
    ...
    <script>
        ...
        document.getElementById('btn_gen').addEventListener('click', () => {
            ...
            contact: {
                ...
                name: "AutoPart Management Division",
                address: "Address, Colombi 02",
