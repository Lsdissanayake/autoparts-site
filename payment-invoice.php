...
<body class="fix-header fix-sidebar">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col text-center">
                                        <br><br><br><br>
                                        <span class="ct-unit">Rs.</span><span class="ct-amount" id="user-ammount">0</span>.00
                                    </div>
                                    <div class="col" >
                                        <div class="form-row">
    ...
    <script>
        ...
        var ammount = document.getElementById('user-ammount');
        ...
        refList.doc(param).get().then((doc) => {
            doc.data().books.forEach((book) => {
                console.log(book);
                payment = payment + parseInt(book.price)*parseInt(book.qty);
                ammount.innerText = payment;
            });
        ...
        btn_pay.addEventListener('click', () => {
            refList.doc(param).update({
                accepted: true,
                name: `Invoice Date: ${new Date().getDate()}/${new Date().getMonth()+1}/${new Date().getFullYear()}.pdf`,
