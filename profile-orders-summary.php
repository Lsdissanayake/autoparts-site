...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Products & Supply Summary</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="#"+user>Profile</a></li>
                        <li class="breadcrumb-item active">Products & Supply Summary</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Overall Transactions</h4>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Products & Supply Summary (Count of Transactions)</h4>
    ...
    <script>
        ...
        refOrders.where("approved", "==", true).orderBy("date", "desc").get().then((snaps) => {
            snaps.forEach((snap) => {
                // refItems.where("category", "==", snap.data().name)
                if(lbls.indexOf(snap.data().date.toDate().getMonth()+1)<0){
                    if(snap.data().category&&snap.data().category=="Products"){
                        dta.push(1);
                        dtas.push(0);
                    } else {
                        dtas.push(1);
                    ...
                    if(snap.data().category&&snap.data().category=="Products"){
                        ...
                        dtas[lbls.indexOf(snap.data().date.toDate().getMonth()+1)] = dtas[lbls.indexOf(snap.data().date.toDate().getMonth()+1)] + 1;
                    }
            ...
            const data = {
                ...
                datasets: [
                    {
                        label: 'Ariculture Products',
                        backgroundColor: 'rgb(255, 99, 132)',
                        borderColor: 'rgb(255, 99, 132)',
                        data: dta.reverse(),
                    },
                    {
                        label: 'Auto Parts Supplies',
