...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Avilable Production</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="profile.php?user="+user>Profile</a></li>
                        <li class="breadcrumb-item active">Available Production</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" id="title">Production</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col text-center">
                                        <h4>Production</h4>
                                        <p>DIsplays Production.</p>
                                        <br>
                                        <button class="btn btn-success" id="btn_gen">Download Production Stats Report</button>
                                        <br>
                                    </div>
                                </div>
    ...
    <script>
        ...
        refItems.where("category", "==", "Products").get().then((docs) => {
            docs.forEach((doc) => {
                
                refUsers.where("username", "==", doc.data().user).get().then((snaps) => {
                    snaps.forEach((snap) => {
                        areas.push({doc:doc.data(), location: snap.data().area});
        ...
        document.getElementById('btn_gen').addEventListener('click', () => {
            var props = {
                    ...
                    fileName: `Production Stats Report Date: ${new Date().getDate()}/${new Date().getMonth()+1}/${new Date().getFullYear()}`,
                    ...
                    invoice: {
                        label: "Prodduction Stats Report:",
                        num: 2022,
                        ...
                        table: Array.from(areas, (item, index)=>([
                            i++,
                            item.doc.name,
                            item.doc.user,
                            item.location,
