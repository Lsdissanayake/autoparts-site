...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Order Auto Parts Items</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Order Auto Parts Items</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
    ...
    <script>
        ...
        var selectedQTY = url.searchParams.get("qty");
        var id = url.searchParams.get("id");

        getItemForOrder(id, user, parseInt(selectedQTY));
