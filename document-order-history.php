...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Order History Report</h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" id="title">Order History Report</h4>
                                <h6 class="card-subtitle" id="user-issue">Download Book Order History Report</h6>
                                <hr>
    ...
    <script>
        ...
        // Data
        refList.where("accepted", "==", true).orderBy("date", "desc").get().then((docs) => {
            docs.forEach((doc) => {
                let term = '';
                let total = 0;
                ...
                console.log(term);
                let obj = {id: doc.id, name: doc.data().issuedBy||"No Name", books: term, total: total};
                items.push(obj);
            })
        })
        ...
        document.getElementById('btn_gen').addEventListener('click', () => {
            var props = {
                    ...
                    fileName: `Order History Report Date: ${new Date().getDate()}/${new Date().getMonth()+1}/${new Date().getFullYear()}`,
                    ...
                    invoice: {
                        ...
                        invDescLabel: `Order History Report`,
