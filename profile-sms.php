...
<body class="fix-header fix-sidebar">
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button class="btn btn-success" id="btn-sms">Send SMS</button>
                            </div>
                        </div>
                                        ...
                                        <div class="tdl-holder">
                                            <div class="tdl-content">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <button class="btn btn-Warning" id="ch-un">New Users</button>
                                                    </li>
                                                    <li>
                                                        <button class="btn btn-info" id="ch-ad">Admin Board</button>
                                                    </li>

                                                    <li>
                                                        <button class="btn btn-success" id="ch-ot">Other</button>
                                                    </li>
                                                </ul>
                                            </div>
                                            <input type="text" class="tdl-new form-control" placeholder="Other">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="js/sms/script.js"></script>
    <!-- scripit init-->
    ...
    <script>
        ...
        var btn_sms = document.getElementById('btn-sms');
        btn_sms.addEventListener('click', () => testSMS());
