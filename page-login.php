                            ...
                            <div class="login-form">
                                ...
                                <!-- <form method="POST" action="php/login.php"> -->
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Your Username" id="rusername">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button class="btn btn-primary btn-flat m-b-30 m-t-30" id="btn_login">Sign in</button>
