...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Issue Taxes</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="profile.php?user="+user>Profile</a></li>
                        <li class="breadcrumb-item active">Issue Taxes</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" id="title">Issue Taxes</h4>
                                ...
                                <button class="btn btn-success" id="btn_gen">Issue</button>
    ...
    <script>
        ...
        var param2 = url.searchParams.get("user");
        var items = [];
        ...
        document.getElementById('btn_gen').addEventListener('click', () => {
            ...
            issueTax(param2, rname.value, total, items);
