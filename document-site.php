...
<body class="fix-header fix-sidebar">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle" id="user-issue">Download User Stats</h6>
                                <hr>
                                <!-- File: <span id="file"></span> || Issued Date: <span id="issued"></span> -->
                                <br>
                                <br>
                                <button class="btn btn-success" id="btn_gen">Download User Stats Report</button>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    <h4 class="card-title">Overall  User Summary</h4>
                                    <h1 class="card-subtitle" id="stat" style="font-size: 80px">00</h1>
                                    From monthly Visits of <span id="month"></span>
                                    <hr>
                                </div>
                            </div>
                    </div>
                    <div class="col-lg-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    From weekly Visits of this week
                                    <hr>
                                </div>
                            </div>
                    </div>
    ...
    <script>
        ...
        stat_w.innerText = score_w;
        month.innerText = monthNames[new Date().getMonth()];

        // Data
        refUsers.get().then((docs) => {
            docs.forEach((doc) => {
                refUsers.doc(doc.id).collection("logs").get().then((snaps) => {
                    console.log(snaps);
                    if(!snaps.empty){
                        score++;
                        score_w++;
        ...
        document.getElementById('btn_gen').addEventListener('click', () => {
            var props = {
                    ...
                    invoice: {
                        ...
                        table: [[1, new Date(), "Weekly User visits", score], [2, new Date(), "Monthly User visits", score_w]],
                        additionalRows: [
                        {
                            col1: 'TOTAL:',
                            col2: '20',
